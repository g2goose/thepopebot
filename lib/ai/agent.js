...
import { createJobTool, getJobStatusTool, getSystemTechnicalSpecsTool, getSkillBuildingGuideTool, getSkillDetailsTool, createStartCodingTool, createStartHeadlessCodingTool, createGetRepositoryDetailsTool } from './tools.js';
...
export async function getCodeAgent({ repo, branch, workspaceId, chatId }) {
  ...
  const tools = [startHeadlessCodingTool, startCodingTool, getRepoDetailsTool];
